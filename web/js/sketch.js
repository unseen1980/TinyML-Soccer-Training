...
//   fill(255);
//   textFont("Roboto+Mono");
//   text(`L E F T : ${total}`, 20, 20);
//   pop();
// }

// //RIGHT KEY
// function right_gesture(total) {
//   r = 224;
//   g = 155;
//   b = 11;
//   sc = 255;
...
//   fill(255);
//   textFont("Roboto+Mono");
//   text(`R I G H T : ${total}`, 20, 40);
//   pop();
// }

// //DOWN KEY
// function poke_gesture(total) {
//   r = 195;
//   g = 184;
//   b = 245;
//   sc = 255;
...
//   fill(255);
//   textFont("Roboto+Mono");
//   text(`P O K E : ${total}`, 20, 60);
//   pop();
// }

// //A KEY
// function twirl_gesture(total) {
//   r = 134;
//   g = 224;
//   b = 163;
//   sc = 255;
...
//   fill(255);
//   textFont("Roboto+Mono");
//   text(`T W I R L : ${total}`, 20, 80);
//   pop();
// }

// //UP KEY
// function pluck_gesture(total) {
//   r = 250;
//   g = 75;
//   b = 67;
//   wave_text = 0;
...
let updateCount = (g) => {
  ...
  let gesturesElement = document.getElementById("gesturesCounter");
  gesturesElement.innerHTML = JSON.stringify(count);
};
